...
const GET_ALL_RECEIPTS_URL =
  "https://store-management-challenge.herokuapp.com/v1/api/get/receipts";
const POST_RECEIPT_URL =
  "https://store-management-challenge.herokuapp.com/v1/api/save/receipt/";
...
//POST Action
const postReceipt = createAsyncThunk(
  "saveReceipt",
  async (receipt: receiptType) => {

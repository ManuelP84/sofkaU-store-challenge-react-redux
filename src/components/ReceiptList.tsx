...
import { getReceipts, getReceiptStatus, getReceiptError, receiptType } from "../state/receiptSlice"
            ...
            <div className="card card-body">
                <table className="justTable">
                  <tbody>
                    ...
                    <tbody>
                      {!receiptError && receipts.map((receipt: receiptType) => <Receipt key={receipt.id} receipt={receipt}/>)}
                    </tbody>
                </table>
            </div>
        </div>
